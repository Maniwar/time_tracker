...
function addGoal() {
  ...
  modal.offsetHeight; // This forces the browser to recalculate
...
function setupEventListeners() {
  ...
  if (showCompletedDeliverables) {
    showCompletedDeliverables.addEventListener('change', (e) => {
...
// Handle if document is already ready
